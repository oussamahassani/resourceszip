...
@Entity
@Table(name = "FraisTTAbonnement")
@EntityListeners(AuditingEntityListener.class)
public class FraisTTAbonnement implements Serializable {
  ...
  public String toString() {
    return "FraisTTAbonnement [fraisTTAbonnementId=" + fraisTTAbonnementId + ", numeroTelephone="
        + numeroTelephone + ", referenceTelecom=" + referenceTelecom + ", dateConnection="
        + dateConnection + ", forfaitInternt=" + forfaitInternt + ", catagorieInternt="
        + catagorieInternt + ", prixService=" + prixService + ", isRaccordement=" + isRaccordement
        + ", codeFrais=" + codeFrais + "]";
  }
