...
@Table(name = "ImportXlsHistoryFile")
public class ImportXlsHistoryFile implements Serializable {
  ...
  public ImportXlsHistoryFile() {
    // TODO Auto-generated constructor stub
  }

  public ImportXlsHistoryFile(Long xlsHistoriqueFile, Date createdDate, String nameFile,
  ...
  public String toString() {
    return "ImportXlsHistoryFile [xlsHistoriquFile=" + xlsHistoriqueFile + ", createdDate="
        + createdDate + ", nameFile=" + nameFile + ", origineNameFile=" + origineNameFile
        + ", successRow=" + successRow + ", errorRow=" + errorRow + ", totalRow=" + totalRow
        + ", user=" + user + "]";
  }
