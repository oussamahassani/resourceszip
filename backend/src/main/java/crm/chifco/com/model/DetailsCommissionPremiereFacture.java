...
@Entity
@Table(name = "DetailsCommissionPremiereFacture")
@EntityListeners(AuditingEntityListener.class)
public class DetailsCommissionPremiereFacture implements Serializable {
  ...
  public DetailsCommissionPremiereFacture() {
    super();
  }

  public DetailsCommissionPremiereFacture(Long id, String referenceClient, String referenceFacture,
