...
public class CodePackGenerator implements ValueGenerator<String> {
  private static final String query = "SELECT NEXT VALUE FOR codepackSeq";
  ...
  public String generateValue(Session session, Object o) {
    ...
    return "pack-" + year + "-" + String.valueOf(result);
  }
}
