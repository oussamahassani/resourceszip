...
public class GenerateSequenceReferenceCommisionAvance implements ValueGenerator<String> {
  private static final String query = "SELECT NEXT VALUE FOR avanceCommisionSeq";
  ...
  public String generateValue(Session session, Object o) {
    ...
    return "avance-" + year + "-" + String.valueOf(result);
  }
}
